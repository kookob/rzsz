/// CRC-16 (XMODEM/CCITT) lookup table.
/// Ported from lrzsz crctab.c.
...
/// Ported from lrzsz crctab.c (cr3tab[]).
...
#[inline]
pub fn update_crc32(crc: u32, byte: u8) -> u32 {
    CRC32_TABLE[((crc ^ byte as u32) & 0xff) as usize] ^ ((crc >> 8) & 0x00ff_ffff)
}

/// Compute CRC-32 over a byte slice (initialized with 0xFFFFFFFF).
...
/// Expected CRC-32 verification constant.
pub const CRC32_MAGIC: u32 = 0xDEBB20E3;
